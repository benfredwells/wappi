...
#
$(foreach src,$(sine_synth_SOURCES),$(eval $(call COMPILE_RULE,$(src),)))

#
# Use the link macro for this target on the list of sources.
#
ifeq ($(CONFIG),Release)
$(eval $(call LINK_RULE,sine_synth_unstripped,$(sine_synth_SOURCES),$(LIBS),$(DEPS)))
$(eval $(call STRIP_RULE,sine_synth,sine_synth_unstripped))
else
$(eval $(call LINK_RULE,sine_synth,$(sine_synth_SOURCES),$(LIBS),$(DEPS)))
endif
